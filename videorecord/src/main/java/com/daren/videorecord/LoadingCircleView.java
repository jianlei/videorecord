...
public class LoadingCircleView extends View {
    ...
    private LoadingCircleViewAnim mLodingCircleViewAnim;//动画效果
    ...
    private void init() {
        ...
        mLodingCircleViewAnim = new LoadingCircleViewAnim();
        ...
        paintBgCircle.setColor(getContext().getResources().getColor(R.color.gray));

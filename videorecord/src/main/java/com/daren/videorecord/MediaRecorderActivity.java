 ...
 *
 */
public class MediaRecorderActivity extends VRBaseActivity
		implements com.yixia.weibo.sdk.MediaRecorderBase$OnErrorListener,
		OnClickListener, com.yixia.weibo.sdk.MediaRecorderBase$OnPreparedListener,
		com.yixia.weibo.sdk.MediaRecorderBase$OnEncodeListener, Chronometer.OnChronometerTickListener {
	...
	private int mMiss = RECORD_TIME_MAX / 1000;// 倒计时 30秒
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		loadViews();
		mCreated = true;
		mCurrentPath = getIntent().getStringExtra(VConstant.RECORD_VIDEO_PATH);
	}
...
//		String hh = miss / 3600 > 9 ? miss / 3600 + "" : "0" + miss / 3600;
	...
	private void initMediaRecorder() {
		...
		mCurrentPath =  VCamera.getVideoCachePath() + key + "/" + key + ".mp4";
...
//					}
	 ...
	 * 丢弃未达标时长视频
	 */
	private void discardUnReachTimeVideo(){
...
//								}
	...
	public void onClick(View v) {
		...
		} else if (id == R.id.importVideo_btn) {
...
//		startActivity(intent);
		...
		intent.putExtra(VConstant.RECORD_VIDEO_PATH, mCurrentPath);
